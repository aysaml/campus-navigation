package cn.edu.lnpu.cns.common.poi;
...
/**
 * Created by wangning113 on 2018/1/16.
 */
public class PoiUtils {
    ...
    public static ResponseEntity<byte[]> exportEmp2Excel(List<Employee> emps) {
        ...
        try {
            ...
            //创建Excel表单
            HSSFSheet sheet = workbook.createSheet("辽宁石油化工大学用户信息表");
            //创建日期显示格式
